...
class GrassEater {
    ...
    eat() {
        ...
        if (newCell) {
            ...
            this.y = newY
            for (var i in qarArr) {
                if (newX == qarArr[i].x && newY == qarArr[i].y) {
                    qarArr.splice(i, 1)
                    break
                }
            }
            ...
            this.x = newX
            this.y = newY
            for (var i in gyolArr) {
                if (newX == gyolArr[i].x && newY == gyolArr[i].y) {
                    gyolArr.splice(i, 1)
                    break
                }
            }
...
class Qar {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 15) {
            ...
            var newGrass = new Qar(newX, newY);
            predatorArr.push(newGrass);
            this.multiply = 0;
        }
    }
...
class Gyol {
    ...
    die() {
        matrix[this.y][this.x] = 0;
        for (var i in gyolArr) {
            if (this.x == gyolArr[i].x && this.y == gyolArr[i].y) {
                gyolArr.splice(i, 1);
                break;
            }
        }
